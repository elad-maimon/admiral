      ...
      <DialogContent className='max-w-md' dir='rtl'>
        ...
        <form onSubmit={handleSubmit} className='space-y-4 pt-4'>
          <div className='space-y-2'>
            <Label>
              שם המשימה/תוצר <span className='text-red-500'>*</span>
            </Label>
            <Input
          ...
          <div className='space-y-2 pt-4 border-t'>
            <Label>
              שיוך לפרויקט / תגית אפיק <span className='text-red-500'>*</span>
            </Label>
            <Select
            ...
            >
              ...
              <SelectContent>
                <SelectItem value='new' className='font-bold text-primary'>
                  -- יצירת פרויקט / אפיק חדש --
                </SelectItem>
                {epics.map(e => (
                  <SelectItem key={e.id} value={e.id}>
                    {e.title} {e.initiative?.title ? `(${e.initiative.title})` : ''}
                  </SelectItem>
                ))}
              </SelectContent>
            </Select>
            ...
            <div className='space-y-4 bg-slate-50 p-4 rounded-md border mt-2'>
              <div className='space-y-2'>
                <Label className='text-xs font-bold text-slate-700'>
                  שם הפרויקט/אפיק (אופציונלי - יועתק מהמשימה אם ריק)
                </Label>
                <Input
              ...
              <div className='space-y-2'>
                <Label className='text-xs font-bold text-slate-700'>
                  יוזמה (Initiative) <span className='text-red-500'>*</span>
                </Label>
                <Select
